/* src/config/pct-config.h.  Generated from pct-config.h.in by configure.  */
/* src/config/pct-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "pct Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "pct Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pctcore"
