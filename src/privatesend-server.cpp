...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all pct related functionality
...
/*
    ...
    allow endless transaction that would bloat pct and make it unusable. To
