    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("pct Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About pct Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pct-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the pct in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 pct, 0.1 pct, 1 pct and 10 pct -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pctpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://pctpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("pct Core is shutting down...") + "<br /><br />" +
