    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("pct Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a pct address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pct: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About pct Core"), this);
    aboutAction->setStatusTip(tr("Show information about pct Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for pct Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your pct addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified pct addresses"));
    ...
    openAction->setStatusTip(tr("Open a pct: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the pct Core help message to get a list with possible pct Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("pct Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to pct network", "", count));
    } else {
...
{
    QString strTitle = tr("pct Core"); // default title
